...
Shortcut Shortcut::_sc[] = {
      ...
      {
         MsWidget::SCORE_TAB,
         STATE_NORMAL | STATE_NOTE_ENTRY_STAFF_PITCHED | STATE_NOTE_ENTRY_STAFF_DRUM | STATE_NOTE_ENTRY_STAFF_CIPHER,
         "interval1",
      ...
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
        //STATE_NORMAL | STATE_NOTE_ENTRY_STAFF_PITCHED | STATE_NOTE_ENTRY_STAFF_DRUM,
         "cipher-1",
         QT_TRANSLATE_NOOP("action","Enter CIPHER  1"),
         QT_TRANSLATE_NOOP("action","Enter cipher 1")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipher-2",
         QT_TRANSLATE_NOOP("action","Enter CIPHER  2"),
         QT_TRANSLATE_NOOP("action","Enter cipher 2")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipher-3",
         QT_TRANSLATE_NOOP("action","Enter CIPHER  3"),
         QT_TRANSLATE_NOOP("action","Enter cipher 3")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipher-4",
         QT_TRANSLATE_NOOP("action","Enter CIPHER  4"),
         QT_TRANSLATE_NOOP("action","Enter cipher 4")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipher-5",
         QT_TRANSLATE_NOOP("action","Enter CIPHER  5"),
         QT_TRANSLATE_NOOP("action","Enter cipher 5")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipher-6",
         QT_TRANSLATE_NOOP("action","Enter CIPHER  6"),
         QT_TRANSLATE_NOOP("action","Enter cipher 6")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipher-7",
         QT_TRANSLATE_NOOP("action","Enter CIPHER  7"),
         QT_TRANSLATE_NOOP("action","Enter cipher 7")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherchord-1",
         QT_TRANSLATE_NOOP("action","Add CIPHER 1"),
         QT_TRANSLATE_NOOP("action","Add cipher 1")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherchord-2",
         QT_TRANSLATE_NOOP("action","Add CIPHER 2"),
         QT_TRANSLATE_NOOP("action","Add cipher 2")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherchord-3",
         QT_TRANSLATE_NOOP("action","Add CIPHER 3"),
         QT_TRANSLATE_NOOP("action","Add cipher 3")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherchord-4",
         QT_TRANSLATE_NOOP("action","Add CIPHER 4"),
         QT_TRANSLATE_NOOP("action","Add cipher 4")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherchord-5",
         QT_TRANSLATE_NOOP("action","Add CIPHER 5"),
         QT_TRANSLATE_NOOP("action","Add cipher 5")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherchord-6",
         QT_TRANSLATE_NOOP("action","Add CIPHER 6"),
         QT_TRANSLATE_NOOP("action","Add cipher 6")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherchord-7",
         QT_TRANSLATE_NOOP("action","Add CIPHER 7"),
         QT_TRANSLATE_NOOP("action","Add cipher 7")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherinsert-1",
         QT_TRANSLATE_NOOP("action","Insert CIPHER 1"),
         QT_TRANSLATE_NOOP("action","Insert cipher 1")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherinsert-2",
         QT_TRANSLATE_NOOP("action","Insert CIPHER 2"),
         QT_TRANSLATE_NOOP("action","Insert cipher 2")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherinsert-3",
         QT_TRANSLATE_NOOP("action","Insert CIPHER 3"),
         QT_TRANSLATE_NOOP("action","Insert cipher 3")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherinsert-4",
         QT_TRANSLATE_NOOP("action","Insert CIPHER 4"),
         QT_TRANSLATE_NOOP("action","Insert cipher 4")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherinsert-5",
         QT_TRANSLATE_NOOP("action","Insert CIPHER 5"),
         QT_TRANSLATE_NOOP("action","Insert cipher 5")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherinsert-6",
         QT_TRANSLATE_NOOP("action","Insert CIPHER 6"),
         QT_TRANSLATE_NOOP("action","Insert cipher 6")
         },
      {
         MsWidget::SCORE_TAB,
         STATE_NOTE_ENTRY_STAFF_CIPHER,
         "cipherinsert-7",
         QT_TRANSLATE_NOOP("action","Insert CIPHER 7"),
         QT_TRANSLATE_NOOP("action","Insert cipher 7")
           },
      {
         MsWidget::SCORE_TAB,
...
//         ShortcutFlags::A_CMD
      ...
      {
         MsWidget::SCORE_TAB,
         STATE_NORMAL | STATE_NOTE_ENTRY_STAFF_PITCHED | STATE_NOTE_ENTRY_STAFF_DRUM | STATE_NOTE_ENTRY_STAFF_CIPHER /*| STATE_NOTE_ENTRY_TAB*/,
         "double-duration",
